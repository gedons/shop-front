        ...
        <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
            ...
            <form @submit.prevent="loginAdmin">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <!-- <a href="#" class="text-[#252525]">Forgot password</a> -->
                </div>
                <div class="mt-4">
                    <button type="submit"
                        class="block w-full py-2 text-center text-white bg-[#252525] border border-[#252525] rounded hover:bg-[#cc2121] hover:text-[#fff] transition uppercase font-roboto font-medium">Login</button>
                </div>
            </form>
