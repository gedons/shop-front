    ...
    <div class="py-4 shadow-sm bg-white">
        <div class="container flex items-center justify-between">
            <router-link :to="{name: 'Index'}">
                <img src="../assets/images/logo-1.svg" alt="Logo" class="w-20">
            </router-link>
            ...
            <div class="flex items-center space-x-4">                 
                <router-link :to="{name: 'Cart'}" class="text-center text-gray-700 hover:text-[#9F2DBE] transition relative">
                    <div class="text-2xl">
                    ...
                    <div
                        ...
                        {{ $store.state.cartCount.cartCount }}
                      </div>
                </router-link>
                <router-link :to="{name: 'UserAccount'}" class="text-center text-gray-700 hover:text-[#9F2DBE] transition relative">
                    <div class="text-2xl">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:block">
              <div class="mx-auto flex items-baseline space-x-6 font-medium">
