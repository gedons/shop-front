<template>
    ...
    <div class="py-4 shadow-sm bg-white">
        ...
        <input class="border-b-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
          ...
          <div class="flex items-center justify-center h-16"> 
            ...
            <div class="hidden md:block">
              <div class="mx-auto flex items-baseline space-x-6 font-poppins">
                ...
                <router-link :to="{name: 'UserProducts'}" class="text-white hover:text-primary transition">Shop</router-link>
                <router-link :to="{name: 'Terms'}" class="text-white hover:text-primary transition">About</router-link>
                <router-link :to="{name: 'Contact'}" class="text-white hover:text-primary transition">Contact</router-link>
                <router-link :to="{name: 'Register'}" class="text-white bg-[#cc2121] border border-[#cc2121] px-3 py-2 rounded-md hover:text-white hover:bg-transparent font-poppins transition">Get Started</router-link>
              </div>
            </div>
